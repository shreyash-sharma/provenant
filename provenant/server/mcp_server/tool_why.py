...
async def provenant_why(
    ...
    if repo == "all":
        if not query:
            return _unsupported_repo_all("provenant_why (health dashboard)")
    ...
    if not query:
        from provenant.core.persistence.crud import get_decision_health_summary
    ...
    from provenant.core.persistence.crud import list_decisions as _list_decisions
