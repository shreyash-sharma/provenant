...
_OPENAI_DEFAULT_TEMPERATURE_ONLY_PREFIXES = ("o1", "o3", "o4")
...
def _requires_default_temperature(model: str) -> bool:
    leaf = _model_leaf(model)
    return leaf.startswith(_OPENAI_DEFAULT_TEMPERATURE_ONLY_PREFIXES)
...
def _openai_reasoning_kwargs(reasoning: ReasoningMode) -> dict[str, Any]:
    """Translate a validated provenant reasoning intent to OpenAI kwargs."""
