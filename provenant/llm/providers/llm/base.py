"""Base provider interface and response types for provenant's LLM abstraction layer.

provenant is model-agnostic by design. Any LLM — cloud or local — that implements
...
class BaseProvider(ABC):
    ...
    provenant is model-agnostic. Any LLM that implements this interface
    ...
    async def generate(
        ...
        Args:
            ...
            temperature:   Sampling temperature. 0.0 is fully deterministic.
                           provenant uses 0.3 for consistent doc style.
