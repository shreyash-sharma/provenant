"""OpenRouter provider for provenant.
...
from provenant.core.rate_limiter import RateLimiter
...
def _openrouter_reasoning_kwargs(reasoning: ReasoningMode) -> dict[str, Any]:
    """Translate a validated provenant reasoning intent to OpenRouter kwargs."""
...
class OpenRouterProvider(BaseProvider):
    ...
    Args:
        ...
        app_title:    App name shown on OpenRouter dashboard. Defaults to "provenant".
        cost_tracker: Accepted for registry compatibility but not used — OpenRouter
                      proxies 200+ models with varying prices, so provenant's fallback
