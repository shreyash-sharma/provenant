"""SQLAlchemy ORM models for provenant persistence layer.
...
provenant.core.ingestion.models.Symbol in files that import from both modules.
"""
...
class WikiSymbol(Base):
    ...
    provenant.core.ingestion.models.Symbol in files that import both.
    """
