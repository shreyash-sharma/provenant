"""Async CRUD operations for the provenant persistence layer.
...
async def upsert_page_from_generated(
    session: AsyncSession,
    generated_page: object,  # provenant.core.generation.models.GeneratedPage
    repository_id: str,
) -> Page:
...
async def recompute_git_percentiles(
    ...
    without a full ``provenant init``.  Returns the number of rows updated.
