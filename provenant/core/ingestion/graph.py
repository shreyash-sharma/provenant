"""Dependency graph builder for the provenant ingestion pipeline.
...
class GraphBuilder:
    ...
    def community_detection(self) -> dict[str, int]:
        ...
        from provenant.core.analysis.communities import detect_file_communities
    ...
    def symbol_communities(self) -> dict[str, int]:
        ...
        from provenant.core.analysis.communities import detect_symbol_communities
    ...
    def execution_flows(self, config: Any | None = None) -> Any:
        ...
        from provenant.core.analysis.execution_flows import (
            ExecutionFlowReport,
